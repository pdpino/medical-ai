...
### Word collector
class WordCollector(WordMatcher):
    """Class to collect target words."""
    def reset(self):
        self._state = list()
...
class WordCollectorPattern(Patterns):
    def __init__(self, *elements):
        super().__init__(*elements)
        for element in elements:
            assert isinstance(element, str), 'Collector elements must be str'
